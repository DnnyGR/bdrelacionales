...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-02-2025 a las 02:15:55
...
(14, 'Axel Armando', 'Beltran Lopez', '233250610700317', '2008-05-13', 1, 'axel.beltran23@cetis107.edu.mx', '6674066013'),
(15, 'Maya', 'Almaral', '23325061070422', '2008-02-12', 0, 'maya.almaral23@cetis107.edu.mx', '6671514276');
...
(1, 'Diseño Grafico', 'Te enseñan a dibujar y a hacer manualidades'),
(2, 'Programacion', 'te enseñan lenguajes de programacion'),
(3, 'Construccion', 'Te enseñan a hacer chalan'),
(4, 'Offimatica', 'te enseñan a usar programas como exel, word, etc'),
(5, 'Contabilidad', 'te enseñan a hacer cuentas'),
(6, 'Electronica', 'hacen circuitos');
...
(1, 'ED no condicionales', 4),
(2, 'ED condicionales', 4),
(3, 'Ingles', 4),
(4, 'Temas Matematicos', 4),
(5, 'Recursos Socio-emocionales', 4),
(6, 'Historia', 4),
(7, 'Reacciones Quimicas', 4),
